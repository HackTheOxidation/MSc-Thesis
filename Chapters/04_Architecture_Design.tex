...
\begin{itemize}
  \item $Lexing : SourceProgram \rarrow TokenStream$
  \item $Parsing : TokenStream \rarrow AbstractSyntaxTree$
  \item $Analysis : AbstractSyntaxTree \rarrow IntermediateRepresentation$
  \item $CodeGeneration : IntermediateRepresentation \rarrow TargetProgram$
\end{itemize}
