...
To annotate the AST with typing information, the typechecker implements the \texttt{typer} function, which 
...
As mentioned earlier in the description of the architecture of the \texttt{hyggec} compiler, the design is inflexible as it
depends on concretizations rather than interfaces. So, we seek a design that is more aligned with the \textit{SOLID} principles.
